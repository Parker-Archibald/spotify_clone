...
import { queueState, searchState } from "@/atoms/PlaylistAtom";
...
const Center = () => {
    ...
    return (
        <div className="flex-grow overflow-y-scroll scrollbar-hide h-screen rounded-l-xl">
            <ErrorPopup isOpen={isOpen} callBack={() => setIsOpen(false)}/>
            {!queueOpen ? (
                <span>
                    {!searchOpen ? (
                        <div>
                                                ...
                                                onMouseLeave={() => {document.getElementById(`${index}Index`).style.display = 'flex'; document.getElementById(`${index}PlayIcon`).style.display = 'none'}}>
                                                    <div className="flex space-x-6 items-center">
                                                        ...
                                                        <div className="flex space-x-4 items-center">
                                                            ...
                                                            <div>
                                                                <div className="truncate w-48 text-white">{item.track.name}</div>
